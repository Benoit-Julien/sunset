...
public class SavePlayerData_C : MonoBehaviour {
	...
	void Update () 
	{
		...
		{
			UniStorm.GetComponent<UniStormWeatherSystem_C>().startTimeMinute = System.DateTime.Now.Minute;
			UniStorm.GetComponent<UniStormWeatherSystem_C>().startTimeHour = System.DateTime.Now.Hour;

			UniStorm.GetComponent<UniStormWeatherSystem_C>().dayCounter = System.DateTime.Now.Day;
			UniStorm.GetComponent<UniStormWeatherSystem_C>().monthCounter = System.DateTime.Now.Month;
			UniStorm.GetComponent<UniStormWeatherSystem_C>().yearCounter = System.DateTime.Now.Year;
			UniStorm.GetComponent<UniStormWeatherSystem_C>().UniStormDate = new System.DateTime(System.DateTime.Now.Year, System.DateTime.Now.Month, System.DateTime.Now.Day);
