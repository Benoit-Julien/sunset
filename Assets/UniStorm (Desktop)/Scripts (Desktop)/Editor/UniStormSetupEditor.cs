...
public class UniStormSetupEditor : EditorWindow
{
	...
	SunShafts[] sunShaftsComponentCheck;
	...
	void OnGUI()
	{
		GUILayout.Label ("UniStorm Auto Player Setup C# - v1.3", EditorStyles.boldLabel);
		...
		{
			if (GameObject.Find("Rain Streaks") != null || GameObject.Find("Snow Dust") != null || GameObject.Find("Rain Mist") != null || GameObject.Find("Splashes") != null || GameObject.Find("Lightning Bugs") != null || GameObject.Find("Windy Leaves") != null || GameObject.Find("Lightning Position") != null)
			{
				EditorUtility.DisplayDialog("Oops!", "You already have UniStorm Particle Effects/Objects in your scene. Please remove them and try again.", "Okay");
			}
